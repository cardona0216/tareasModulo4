...
SECRET_KEY = 'django-insecure-!(xt)9!(b795bf263sq+lcr9&9&(3w8mod0(4)!v^c161l3vp1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tareas',  # Nombre de tu base de datos
        'USER': 'postgres',  # Usuario de la base de datos
        'PASSWORD': 'samuel0216',  # Contraseña del usuario
